      ...
      <div className="Classify container">
        {!this.state.modelLoaded && (
          <Fragment>
            ...
            <span className="loading-model-text">Carregando classificador</span>
          </Fragment>
        )}
        ...
        {this.state.modelLoaded && (
          <Fragment>
            ...
            >
              Tire uma foto ou utilize uma imagem de sua galeria
            ...
            <Collapse in={this.state.photoSettingsOpen}>
              <div id="photo-selection-pane">
                ...
                >
                  <Tab eventKey="camera" title="Tire uma foto">
                    <div id="no-webcam" ref="noWebcam">
                      <span className="camera-icon">
                        <FaCamera />
                      </span>
                      Nenhuma câmera encontrada. <br />
                      Utilize um dispositivo com câmera ou faça o upload de uma
                      imagem.
                    </div>
                  ...
                  <Tab
                    eventKey="localfile"
                    title="Selecione uma imagem na galeria"
                  >
